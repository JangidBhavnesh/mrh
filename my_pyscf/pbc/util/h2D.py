...
def plot_bands(cell, e_kn, filename="h2D_bands.png", title=r"H$_2$ Band Structure"):
    # Restricted HF Only
    au2ev = 27.21139
...
if __name__ == "__main__":
    kmesh = (8, 8, 1)
    h2D = make_h2_2D(intraH=0.74, interH=1.5, nx = 1, ny=1, vacuum=17.5)
    cell = get_cell(h2D)
    ...
    plot_bands(cell, e_kn, filename="h2D_bands.png", title=rf"H$_2$ Band Structure {kmesh}")
