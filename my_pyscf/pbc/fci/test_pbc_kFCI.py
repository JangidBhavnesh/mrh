...
from mrh.my_pyscf.pbc.fci.direct_spin1_kfci import contract_2e_k, _unpack
...
class kFCIHelperFunctions:
    ...
    def compare_kfci_nkpts_gt1_vs_full_mol(self, nkpts=3, ncas=3, nelec=(2, 1), target_k=0, seed=12):
        '''
            ...
            for target_k in range(nkpts):
                with self.subTest( nkpts=nkpts, ncas=ncas, nelec=nelec, target_k=target_k):
                    ...
                    sigma_k, sigma_ref_k, diff = (
                        helper.compare_kfci_nkpts_gt1_vs_full_mol(nkpts=nkpts, ncas=ncas, nelec=nelec, 
