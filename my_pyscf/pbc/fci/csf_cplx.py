...
if __name__ == "__main__":
    ...
    e_cplx_csf_nondavidson = cplx_CSFSolver(h0cplx, h1cplx, h2cplx, norb, nelec, davidson_only=False, pspace_size=400)
    ...
    print("\nSummary of results:")
    print(f"Real CSF FCI Energy   : {e_real_csf:.14f}")
    print(f"Complex CSF FCI Energy: {e_cplx_csf.real:.14f}")
    print(f"c-CSF FCI Energy  (ND): {e_cplx_csf_nondavidson.real:.14f}")
    print(f"Complex Det FCI Energy: {e_cplx_det.real:.14f}")
